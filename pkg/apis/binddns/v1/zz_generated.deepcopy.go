...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DnsDomainCondition) DeepCopyInto(out *DnsDomainCondition) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DnsDomainCondition.
func (in *DnsDomainCondition) DeepCopy() *DnsDomainCondition {
	if in == nil {
		return nil
	}
	out := new(DnsDomainCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DnsDomainStatus) DeepCopyInto(out *DnsDomainStatus) {
	*out = *in
	if in.Condition != nil {
		...
		*out = make(map[string]DnsDomainCondition, len(*in))
